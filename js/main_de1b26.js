...
function X00ActivitiesAdd() {
    ...
    $('<div style="text-align: center;"><h3><img src="' + X00CF[X00Random(0, X00CF.length)] + '" alt="Country Flag" class="country-flag" /><span class="subheader ipsubheader">IP: ' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + randX[X00Random(0, randX.length)] + '.' + X00Random(1, 255) + '</span> <span class="subheader">generierte</span> <span class="subheader recgenvalue" style="font-weight: bold; color: #ffcc05;"><img src="img/vbucks.png" alt="" class="cr-gem-icon" />' + X00Vals[X00Random(0,X00Vals.length)] + ' V-Bucks</span> <span class="subheader"><span id="X00ActivitySeconds" class="ipsubheader"> Vor 0 Sekunden</span> </span></div>').appendTo('#X00Activities').hide().fadeIn(250);
    X00ActivityIntervalSeconds = setInterval(function() {
        X00ActivitySecondsCurrent++;
        $('#X00ActivitySeconds').html('Vor '+X00ActivitySecondsCurrent + ' Sekunden');
    }, 1000);
}
